  ...
  return (
    <div className="animate-fade-in">
      <div className="page-header flex-between">
        ...
        <button className="primary" onClick={() => setEditingItem({ name: '', description: '', price: 100, item_type: 'title', value: '', is_active: 1 })}>
            ...
            <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <input required type="number" min="0" value={editingItem.price || 0} onChange={(e) => setEditingItem({...editingItem, price: parseInt(e.target.value) || 0})} style={{ width: '100%', boxSizing: 'border-box' }} />
                </div>
                <div style={{ flex: 1 }}>
              ...
              <div style={{ marginTop: '0.5rem' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                  <input type="checkbox" checked={editingItem.is_active === 1} onChange={(e) => setEditingItem({...editingItem, is_active: e.target.checked ? 1 : 0})} style={{ width: '20px', height: '20px' }} />
